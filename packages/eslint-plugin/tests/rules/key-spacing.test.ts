...
import rule, { MessageIds, Options } from '../../src/rules/key-spacing';
import { RuleTester } from '../RuleTester';

// function overrides(key: string, value: Options[0]): Options[0] {
//   return {
...
// ruleTester.run<MessageIds, Options>('key-spacing (base rule)', rule, {
//   valid: [
//     '({\n})',
//     '({\na: b\n})',
//     {
...
//     },
//     {
//       code: ['var x = {', '        foo: 10,', ' /*lol*/b  : 20', '};'].join(
//         '\n',
//       ),
//       options: [{ align: 'colon' }],
//     },
...
//     },
//     {
//       code: ['var test = {', '    prop: 123,', '    a,', '    b', '};'].join(
//         '\n',
//       ),
//       parserOptions: { ecmaVersion: 6 },
//     },
//     {
//       code: ['var test = {', '    prop: 456,', '    c,', '    d', '};'].join(
//         '\n',
//       ),
//       options: [{ align: 'value' }],
//       parserOptions: { ecmaVersion: 6 },
...
//     },
//     {
//       code: ['var obj = {', '    foobar: 42,', '    bat:    2', '};'].join(
//         '\n',
//       ),
//       options: [
//         {
...
ruleTester.run<MessageIds, Options>('key-spacing (extension rule - typescript syntax)', rule, {
  valid: [
//   `
// interface Foo {
//   a: number;
...
interface Foo {
  ...
  ccc      : string;
      ...
      `,
      errors: [
        { messageId: 'missingKey', data: { computed: '', key: 'ccc' } },
      ],
      options: [{ align: 'colon', afterColon: true }],
    },
    {
      code: `
interface Foo {
...
interface Foo {
  ...
  ccccc: string;
      ...
      `,
      errors: [
        { messageId: 'extraKey', data: { computed: '', key: 'aa' } },
      ],
      options: [{ align: 'colon', afterColon: true }],
    },
  ],
